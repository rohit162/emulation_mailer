...
@WebServlet(name = "ViewMailServlet", value = "/ViewMailServlet")
...
//                    out.println("<a href='TrashServlet?Id=" + Id + "'>Trash</a>");
...
//                if (rs.next()) {
//                    out.print("<h1>" +subject+ "</h1><hr/>");
//                    out.print("<p><b>Message:</b><br/> " + Message + " <br/> <b>By: " + Sender + "</b></p>");
//                    out.println("<a href='TrashServlet?Id=" + id + "'>Trash</a>");
//                    out.print("<p><a href='DeleteServlet?id=" + id + "'>Delete Mail</a></p>");
//
//                }
//            }
//            catch (Exception e) {
